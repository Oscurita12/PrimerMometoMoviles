    ...
    <View style={[styles1.container,styles1.alignViews,{borderRadius:10,flexDirection: 'column'}]}>
     <View>
          ...
          <TextInput
            ...
            style={{fontSize:17, borderWidth:2, borderColor:'#884EA0',padding:10, textAlign:'center',borderRadius:10}}
          ...
          <TextInput
            ...
            style={{fontSize:20, borderWidth:2, borderColor:'#884EA0',padding:10, textAlign:'center',borderRadius:10}}
